    ...
    <main className="shell">
      <section className="hero">
        ...
        <div className="heroCopy">
          ...
          <p className="lede">
            Pass the agent trial, sign a free wallet message, and the relayer writes your
            wallet, score, proof hash, and rank to Ritual Testnet. You leave a real on-chain
            trace without holding test tokens.
          </p>
          ...
          <div className="actions">
            ...
            <span className="proofNote">Contract state records the user wallet; the relayer pays gas.</span>
          </div>
        </div>
