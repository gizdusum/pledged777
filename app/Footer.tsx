  ...
  return (
    <footer className="footer">
      ...
      <div className="footerSocials">
        <a href="https://x.com/gizdusumandnode" target="_blank" rel="noreferrer" className="footerSocialLink">
          ...
          <span>gizdusumandnode</span>
        </a>
        <span className="footerDivider">·</span>
        <a href="https://github.com/gizdusum" target="_blank" rel="noreferrer" className="footerSocialLink">
          <svg viewBox="0 0 24 24" className="footerSvg" aria-hidden="true">
